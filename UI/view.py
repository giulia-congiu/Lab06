...
class View(ft.UserControl):
    def __init__(self, page: ft.Page):
        ...
        self.btnPrintTopV = None
        self.btnPrintAnalizzaV = None
    ...
    def load_interface(self):
        ...
        self.btnPrintTopV = ft.ElevatedButton(text="Top vendite",
                                                        on_click=self._controller.handlePrintTopV, width=150)
        self.btnPrintAnalizzaV = ft.ElevatedButton(text="Analizza vendite",
                                                   on_click=self._controller.handlePrintAnalizzaV, width=200)

        row2 = ft.Row([self.btnPrintTopV, self.btnPrintAnalizzaV],
